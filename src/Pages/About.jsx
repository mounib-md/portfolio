...
import { FileText, Code, GraduationCap, ArrowUpRight, Sparkles } from "lucide-react"
import AOS from 'aos'
...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      Designing & deploying robust cloud infrastructures
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
...
const StatCard = memo(({ icon: Icon, color, value, label, description, animation }) => (
  <div data-aos={animation} data-aos-duration={1300} className="relative group w-full">
    <div className="relative z-10 bg-gray-900/50 backdrop-blur-lg rounded-2xl p-6 border border-white/10 overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl h-full flex flex-col justify-between">
      ...
      <div>
        <p 
          className="text-sm uppercase tracking-wider text-gray-300 mb-2 font-semibold"
          data-aos="fade-up"
          data-aos-duration="800"
          data-aos-anchor-placement="top-bottom"
        >
...
const AboutPage = () => {
  ...
  useEffect(() => {
    const updateStats = () => {
      ...
      setTotalProjects(storedProjects.length || 4);
    };
  ...
  const statsData = useMemo(() => [
    {
      ...
      description: "Cloud & System architectures deployed",
    ...
    },
    {
      ...
      value: 4,
      label: "Years of Academic Journey",
      description: "2 Yrs Intensive Prep Classes + 2 Yrs Engineering Degree",
      animation: "fade-left",
    },
  ], [totalProjects]);
  ...
  return (
    ...
    >
      ...
      <div className="w-full mx-auto pt-8 sm:pt-12 relative">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
              Computer Engineering student at the National School of Engineers of Carthage (ENICarthage), specializing in cloud infrastructure design and deployment. Hands-on experience with multi-tier architecture, containerization (Docker), Kubernetes orchestration, CI/CD pipelines, Infrastructure as Code (Terraform, Ansible), monitoring (Prometheus, Grafana), and low-level system programming. Driven by building robust, scalable, and end-to-end controlled solutions.
            </p>
            ...
            >
              ...
              <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
                "Building robust, scalable, and end-to-end controlled cloud solutions."
              </blockquote>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a 
                href="/cv.pdf" 
                download="CV_Mohamed_Mounib_MEDIOUNI.pdf" 
              ...
              >
                ...
                >
                  <FileText className="w-4 h-4 sm:w-5 sm:h-5" /> Download / Request CV
                </button>
              </a>
        ...
        <a href="#Portofolio" className="flex justify-center w-full">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-16 cursor-pointer max-w-3xl w-full mx-auto justify-center">
            {statsData.map((stat) => (
